...
SECRET_KEY = 'django-insecure--v(9&8^7k7g4u(*(3^z&z@meauo7+@%-e3k=ug=n)+(pvled#-'
...
MIDDLEWARE = [
    ...
    'finance.middleware.PreferenceMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'finance.context_processors.user_preferences',
            ],
        },
    },
]
...
LANGUAGE_COOKIE_NAME = 'finance_language'
